    ...
    <>
      ...
      <main className=''>
        <section className="container mx-auto p-4 flex justify-center items-center h-1/2">
          <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-4 border-2 border-gray-200">
            ...
            <form id="pizza-form" className='text-2xl'>
              ...
              <button id="analyze-btn" className="bg-gradient-to-tl from-red-700 to-blue-600 hover:text-black text-white font-bold my-2 py-2 px-4 rounded w-full"
